...
class RingNet_inference(object):
    def __init__(self, config, sess=None):
        ...
        self.images_pl = tf.compat.v1.placeholder(tf.float32, shape=input_size, name='input_images')
        ...
        # Load graph.
        self.saver = tf.compat.v1.train.import_meta_graph(self.load_path+'.meta')
